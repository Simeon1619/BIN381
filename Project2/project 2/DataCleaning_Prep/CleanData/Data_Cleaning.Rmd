...
# Load the data
df <- read_csv("C:/Users/faase/OneDrive/Desktop/BIN/Project/Datasets/water_national_zaf.csv", skip = 2)
...
#If to much dataloss occurs , dont drop rows and keep "messy" values
#df <- df %>% drop_na()
...
#Inspect and Save
glimpse(df)  
write_csv(df, "C:/Users/faase/Downloads/Project Datasets-20250906/Project Datasets/Project Datasets_clean/water_national_zaff_clean.csv")
